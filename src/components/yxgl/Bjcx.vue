    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>办件跟踪</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        ...
        <div class="container">
                        ...
                        <el-row>
                            ...
                            <el-col :span='24'>
                                ...
                                <el-form-item label="状态：">
                                    <el-select v-model="searchForm.shifja" :clearable="true" placeholder="状态" class="handle-select mr10">
            ...
            >
                ...
                <el-table-column prop="anh" label="案号" width="120" align="center"></el-table-column>
                ...
                <el-table-column prop="jiessj" label="申请时间" width="100" align="center" ></el-table-column>
                <el-table-column prop="shifja" label="状态" width="100" align="center" ></el-table-column>
                <el-table-column label="办件跟踪" width="80" align="center">
    ...
    methods: {
        ...
        getData() {
            fetchData(this.query).then(res => {
                console.log('res',res)
                console.log('this.query.shenqsj',this.query.shenqsj);
                console.log('this.query.shifja',this.query.shifja);
                ...
                // if (this.query.shenqsj != '') {
                //     this.tableData = this.tableData.filter(item => {
                //         if (this.query.shenqsj == item.shenqsj) {
                //             return true;
                //         }
                //     })
                // }
        ...
        handleSearch() {
            ...
            this.query.shenqsj = (typeof this.searchForm.shenqsj !== 'undefined' && this.searchForm.shenqsj != '') ? this.searchForm.shenqsj : '';
            this.query.shifja = (typeof this.searchForm.shifja !== 'undefined' && this.searchForm.shifja != '') ? this.searchForm.shifja : '';
