    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>公共服务事项查询</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
        ...
        <el-dialog title="比对分析" :visible.sync="bdfxVisible" width="85%">
            <v-sxdbfx></v-sxdbfx>
            <span slot="footer" class="dialog-footer">
                <el-button @click="bdfxVisible = false">取 消</el-button>
                <el-button type="primary" @click="bdfxVisible = false">确 定</el-button>
            </span>
        </el-dialog>

        <el-dialog title="历史记录" :visible.sync="lisjlVisible" width="85%">
            <v-lisjl></v-lisjl>
            <span slot="footer" class="dialog-footer">
                <el-button @click="lisjlVisible = false">取 消</el-button>
                <el-button type="primary" @click="lisjlVisible = false">确 定</el-button>
            </span>
        </el-dialog>
...
import vSxdbfx from './Sxdbfx.vue';
import vLisjl from './Lisjl.vue';
export default {
    name: 'basetable',
    data() {
        return {
...
　　　　　　//离开区域的时候树消失
        ...
        handleLiuc(index, row) {
            this.bdfxVisible = true;
        },
        // 表单
        handleForm(index, row) {
            this.lisjlVisible = true;
        },
        // 文书
